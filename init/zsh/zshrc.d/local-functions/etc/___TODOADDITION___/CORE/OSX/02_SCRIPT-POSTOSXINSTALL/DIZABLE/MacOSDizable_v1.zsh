...
#####                         #####
###   USER SERVICES INIT LIST   ###
#####                         #####

	##### SYSTEM LAUNCH AGENTS LIST #####
	libraryLaunchAgents="
...
#####                            #####
###   PER-USER SERVICES INIT LIST  ###
#####                            #####
	
	##### PER-AGENT LAUNCH AGENTS LIST #####
	userLaunchAgents="com.adobe.ARM.df0ab5bbe6f698196fcc21e3c1e66dcb758bd911f4d637272d9d8109"

#####             #####
###   PREFERENCES   ###
#####             #####
	##### SYSTEM PREFERENCES LIST #####
	libPreferences="com.apple.airport.opproam.plist com.apple.Bluetooth.plist         \
	 				com.apple.commerce.plist com.apple.driver.AppleIRController.plist \
	 				com.apple.SoftwareUpdate.plist com.apple.storeagent.plist         \
	 				com.apple.TimeMachine.plist com.apple.ViewBridge.plist    
	 				org.cups.printers.plist Xsan"
...
##### LIBRARY LAUNCH DAEMONS PROCESS #####
LibrarylaunchDaemonsPatternAction () {
		echo "#################################"  
